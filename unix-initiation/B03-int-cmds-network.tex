...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\texorpdfstring{Connexion {\`a} une autre machine -- commande {\tt telnet}}{Connexion {\`a} une autre machine -- commande telnet}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\texorpdfstring{Transfert de fichiers - commande {\tt ftp}}{Transfert de fichiers - commande ftp}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\texorpdfstring{Connexion automatique -- commande {\tt rlogin}}{Connexion automatique -- commande rlogin}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\texorpdfstring{Transfert de fichiers automatique -- commande {\tt rcp}}{Transfert de fichiers automatique -- commande rcp}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\texorpdfstring{Ex{\'e}cution d'une commande {\`a} distance - commande {\tt rsh} (ou {\tt remsh})}{Ex{\'e}cution d'une commande {\`a} distance - commande rsh (ou remsh)}}
