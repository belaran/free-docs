...
La commande  \index{scp@\texttt{scp}}<<~\texttt{scp}~>> permet d'utiliser le protocole ssh pour transférer des fichiers, mais dans un flux chiffré. 
