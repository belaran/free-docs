...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\texorpdfstring{\label{adv-programming-ex1}Tri par adresse IP du fichier "{\tt /etc/hosts}"}{Tri par adresse IP du fichier "/etc/hosts"}}
...
%%%%%%%%%%%%%%
\subsubsection{\texorpdfstring{\label{adv-programming-ex3-devlmkprj}Cr{\'e}ation des nouvelles entr{\'e}es "{\sl projet}"}{Cr{\'e}ation des nouvelles entr{\'e}es "projet"}}
...
%%%%%%%%%%%%
\subsubsection{\texorpdfstring{\label{adv-programming-ex3-pgmdef}Fichier "{\tt mkpasswd.define}"}{Fichier "mkpasswd.define"}}
...
%%%%%%%%%%%%
\subsubsection{\texorpdfstring{\label{adv-programming-ex3-pgmfct}Fichier "{\tt mkpasswd.functions}"}{Fichier "mkpasswd.functions"}}
...
%%%%%%%%%%%%
\subsubsection{\texorpdfstring{\label{adv-programming-ex3-pgmchk}Fichier "{\tt mkpasswd.check}"}{Fichier "mkpasswd.check"}}
