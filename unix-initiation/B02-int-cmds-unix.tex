...
\subsection{\texorpdfstring{Commandes {\tt mkdir} et {\tt rmdir}}{Commandes mkdir et rmdir}}
...
%%%%%%%%%%%%
\subsection{\texorpdfstring{R{\'e}pertoires <<~{\tt .}~>> et <<~{\tt ..}~>>}{R{\'e}pertoires <<~.~>> et <<~..~>>}}
...
%%%%%%%%%%%
\subsection{\texorpdfstring{Filtre {\tt grep}}{Filtre grep}}
